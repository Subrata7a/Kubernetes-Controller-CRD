...
// SubrataLister helps list Subratas.
// All objects returned here must be treated as read-only.
type SubrataLister interface {
	// List lists all Subratas in the indexer.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*v1alpha1.Subrata, err error)
	// Subratas returns an object that can list and get Subratas.
	Subratas(namespace string) SubrataNamespaceLister
	SubrataListerExpansion
}
...
// All objects returned here must be treated as read-only.
type SubrataNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.Subrata, error)
	SubrataNamespaceListerExpansion
}
